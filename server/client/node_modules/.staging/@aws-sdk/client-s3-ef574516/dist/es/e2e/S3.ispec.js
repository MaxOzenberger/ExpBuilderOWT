...
describe("@aws-sdk/client-s3", function () {
    ...
    describe("PutObject", function () {
        ...
        after(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, client.deleteObject({ Bucket: Bucket, Key: Key })];
                    case 1:
                        _a.sent();
                        return [2];
                }
        ...
        if (isBrowser) {
            ...
            it("should succeed with blob body", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, client.putObject({
                                Bucket: Bucket,
                                Key: Key,
                                Body: new Blob([buf_1]),
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, client.putObject({ Bucket: Bucket, Key: Key, Body: body })];
                    case 1:
                        _a.sent();
                        return [4, client.getObject({ Bucket: Bucket, Key: Key })];
                    case 2:
                        result = _a.sent();
                        expect(result.$metadata.httpStatusCode).to.equal(200);
                        if (isBrowser) {
    ...
    describe("ListObjects", function () {
        before(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Key = "" + Date.now();
                        return [4, client.putObject({ Bucket: Bucket, Key: Key, Body: "foo" })];
                    case 1:
                        _a.sent();
                        return [2];
                }
        ...
        it("should succeed with valid bucket", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, client.listObjects({
                            Bucket: Bucket,
                        })];
                    case 1:
                        result = _a.sent();
    ...
    describe("MultipartUpload", function () {
        ...
        afterEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!UploadId) return [3, 2];
                        return [4, client.abortMultipartUpload({
                                Bucket: Bucket,
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4, client.deleteObject({
                            Bucket: Bucket,
                            Key: multipartObjectKey,
                        })];
                    case 3:
        ...
        it("should successfully create, upload list and complete", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4, client.createMultipartUpload({
                            Bucket: Bucket,
                            Key: multipartObjectKey,
                        })];
                    case 1:
                    ...
                    case 3:
                        ...
                        return [4, client.completeMultipartUpload({
                                Bucket: Bucket,
                                Key: multipartObjectKey,
                                UploadId: UploadId,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4, client.listMultipartUploads({
                                Bucket: Bucket,
                            })];
                    case 3:
